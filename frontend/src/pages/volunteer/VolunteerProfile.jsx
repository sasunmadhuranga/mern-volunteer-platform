            ...
            <div className="w-full max-w-2xl bg-white shadow-lg rounded-xl p-6 relative">
                        ...
                        {isEditing && (
                            <>
                                {preview || profilePicUrl ? (
                                    ...
                                    <label
                                        className="absolute bottom-0 right-0 bg-sky-600 hover:bg-sky-700 text-white p-1 rounded-full cursor-pointer"
                                        title="Upload photo"
                                    >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {isEditing && (
                        <button
                            type="submit"
                            className="w-full text-white bg-sky-600 hover:bg-sky-700 rounded-lg py-2 transition-opacity duration-200"
                        >
                            Save Changes
                        </button>
                    )}
...
// Component for rendering fields based on edit mode
