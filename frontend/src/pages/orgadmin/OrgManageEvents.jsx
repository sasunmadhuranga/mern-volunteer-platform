    ...
    return(
        <div className="flex justify-center items-center bg-sky-100 px-4 py-12 md:px-20 lg:px-40">
            <div className="w-full max-w-6xl relative">
                ...
                {events.length === 0 ? (
                    <p className="text-gray-600 text-center">You haven't published any event yet.</p>)
                : (
                        ...
                        {events.map(event => {
                            return(
                                ...
                                >
                                    ...
                                    <p className="text-sm font-gray-700"><strong>Location:</strong> {event.location}, {event.city}</p>
                                    <p className="text-sm font-gray-700"><strong>Duration:</strong> {" "} 
                                    {new Date(event.startDate).toLocaleDateString()} - 
                                    {new Date(event.endDate).toLocaleDateString()}<br />
                                    </p>
                                    <p className="text-sm font-gray-700"><strong>Status:</strong> {event.status}, {event.city}</p>
